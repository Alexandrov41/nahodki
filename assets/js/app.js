...
const COST = {
  ...
  'art:Ideogram':'бесплатно хватает: 25 запросов в день в медленной очереди',
  'art:Flux':'через агрегатор ~$8 за пару сотен кадров, локально бесплатно',
  'art:Kandinsky':'0 ₽ — российский сервис, оплата не нужна вовсе',
  'art:Adobe Firefly':'$5 за 100 кредитов, беру только под коммерцию',
  'banner:Recraft':'$12 — ради кириллицы на макетах, окупается первой же серией',
  'banner:GPT Image 2':'входит в подписку ChatGPT, отдельно не плачу',
  'video:Hailuo':'~$8 за полсотни клипов, самый дешёвый вход в видео',
  'video:Seedance 2.0':'дорого: $1+ за клип, беру только под сложную физику',
  'video:Pika':'$10, но пользуюсь редко — под быстрые правки готового',
  'anim:Kling':'та же подписка, что и на видео, отдельной строки нет',
  'anim:Hedra':'бесплатного тарифа хватает на проверку идеи',
  'sound:Suno':'$10 — при десяти треках в день бесплатного не хватает',
  'sound:Яндекс SpeechKit':'рублями, копейки за минуту синтеза',
  'sound:Udio':'держу бесплатным как второе мнение к Suno',
  'text:Gemini':'бесплатно, плачу только за Nano Banana внутри',
  'text:DeepSeek':'0 ₽ — и это главный аргумент',
  'text:GigaChat':'бесплатно, оплата рублями если упрёшься в лимит',
  'code:GitHub Copilot':'$10, но с Cursor держать оба смысла нет',
  'code:Lovable':'$25 — окупается, если собираешь сайты регулярно',
  'code:v0':'бесплатного хватает на пару экранов в месяц',
  'research:NotebookLM':'бесплатно, лимитов на практике не встречал',
  'research:Deep Research':'входит в подписку, отдельно не считаю',
  'office:Gamma':'$10 — беру помесячно под конкретный питч',
  'office:Notion AI':'$10 сверх обычной подписки Notion',
  'office:Canva AI':'бесплатного тарифа хватает под сторис',
  'agent:Manus':'кредиты кончаются быстро, реально $20+ в активный месяц',
  'agent:Make':'бесплатных 1000 операций хватает на пару сценариев',
  'agent:n8n':'0 ₽ на своём сервере, платишь только за хостинг',
  'meet:Otter':'бесплатных 300 минут хватает, если встреч немного',
  'meet:Fireflies':'бесплатно с ограничением хранилища',
  'edit:Photoroom':'$10 — под карточки окупается сразу',
  'edit:Topaz':'разовая покупка, а не подписка — редкий случай',
  'dub:ElevenLabs Dubbing':'входит в подписку ElevenLabs',
  'dub:HeyGen Translate':'входит в подписку HeyGen',
  'avatar:Hedra':'бесплатно для проверки, дальше от $10',
  'avatar:Synthesia':'$29 — дорого, беру только под корпоративные задачи',
  'mp:Fabula AI':'платишь за скачивание, ~300 ₽ за товар',
  'mp:MPCard':'рублями, тариф зависит от объёма каталога',
  'mp:Supa':'от 490 ₽ в месяц, российский сервис',
  '3d:Meshy':'$20 при активной работе, бесплатного хватает на пробу',
  '3d:Tripo':'бесплатного тарифа хватает на несколько моделей в день',
  'banner:Ideogram':'бесплатно, но на этом тарифе просят указывать авторство',
  'video:Runway':'~$12 через агрегатор, беру под конкретные задачи',
  'anim:Runway':'та же подписка, что и на видео',
  'art:GPT Image 2':'входит в подписку ChatGPT, отдельно не плачу',
  'art:Stable Diffusion':'0 ₽, но нужна видеокарта — плата железом, а не деньгами',
  'art:Шедеврум':'0 ₽ — приложение Яндекса, оплата не предусмотрена',
  'banner:Nano Banana Pro':'та же подписка, что и на картинки',
  'banner:Canva AI':'бесплатного хватает, Pro за $12 брал разово',
  'video:Luma Ray 3':'~$10 через агрегатор за полсотни клипов',
  'video:Higgsfield':'от $9, но кредиты уходят быстро на пресетах',
  'video:Wan':'0 ₽ на своём железе, нужна мощная видеокарта',
  'video:Kandinsky Video':'0 ₽ — Сбер, российский сервис',
  'sound:Fish Audio':'бесплатного тарифа хватает на пробу клона голоса',
  'text:Grok':'$8 в составе подписки X, отдельно смысла нет',
  'text:YandexGPT / Алиса':'0 ₽ — уже в браузере и колонке',
  'text:Qwen':'0 ₽, открытая модель',
  'text:Le Chat':'0 ₽ без регистрации, платный тариф не нужен',
  'avatar:Higgsfield Speak':'кредиты Higgsfield, отдельной подписки нет',
  'edit:Nano Banana Pro':'та же подписка, что и на генерацию',
  'edit:Flux Kontext':'0 ₽ локально, если есть железо',
  'edit:Magnific':'$39 — дорого, беру помесячно под печать',
  'dub:Descript':'$15, окупается если монтируешь регулярно',
  'code:Windsurf':'$15, но с Cursor держать оба незачем',
  'research:Яндекс Нейро':'0 ₽ — прямо в поиске',
  'office:NotebookLM':'бесплатно, лимитов на практике не встречал',
  'agent:ChatGPT Agent':'входит в подписку ChatGPT',
  'agent:Claude Computer Use':'через API, платишь за токены по факту',
  'meet:tl;dv':'бесплатного хватает при паре встреч в неделю',
  '3d:Rodin':'$20 — беру только когда модель идёт в продакшен',
  '3d:Spline':'бесплатного хватает под сцену на сайт',
  'mp:Botika':'от $20, окупается на первой же серии лукбука'
};
...
const SECTIONS = [
  ...
  {id:'showcase',n:'07', title:'Витрина работ',        folio:'12 разборов', fam:'trade',
  ...
  {id:'fails',   n:'09', title:'Что сломалось',        folio:'8 разборов', fam:'motion',
...
const SHOWCASE = [
  ...
  {id:'sh-word', fam:'word', art:'show-word',
   ...
   stack:['text:Claude','banner:Recraft'],
  ...
  {id:'sh-image2', fam:'image', art:'show-image2',
   title:'Предметный кадр без съёмки',
   task:'Показать товар на однородном фоне, когда фотостудии нет, а карточка нужна сегодня.',
   stack:['art:Flux','edit:Photoroom'],
   how:'Flux даёт правдоподобный предмет и свет, Photoroom обтравливает и подставляет ровный фон. Ключевое — задать в промпте одну точку света: без этого модель рисует плоско.',
   catch:'Просить «фото товара» бесполезно. Работает описание съёмки: объектив, высота камеры, мягкий свет слева, тень вправо.',
   time:'18 минут, 9 кадров'},

  {id:'sh-motion2', fam:'motion', art:'show-motion2',
   title:'Раскадровка движения камеры',
   task:'Договориться с заказчиком о движении до того, как тратить генерации видео.',
   stack:['video:Kling','art:Nano Banana Pro'],
   how:'Каждый кадр — отдельная фаза наезда. Рисую одним изображением с четырьмя окнами, чтобы стиль не поплыл, дальше по нему собираю видео.',
   catch:'Kling капризен к тексту: движение надёжнее задавать первым кадром, а не словами «наезд камеры».',
   time:'22 минуты на серию'},

  {id:'sh-sound2', fam:'sound', art:'show-sound2',
   title:'Обложка подкаста',
   task:'Визуал под аудио, который читается и в ленте, и на экране блокировки.',
   stack:['sound:ElevenLabs','banner:Recraft'],
   how:'Сначала эпизод, потом обложка под его настроение. Композиция строится от квадрата 300×300 — если в этом размере не читается, переделываю.',
   catch:'Модель тянет добавить микрофон и наушники. Абстрактная волна работает лучше: не устаревает от выпуска к выпуску.',
   time:'14 минут'},

  {id:'sh-word2', fam:'word', art:'show-word2',
   title:'Отчёт по конкурентам',
   task:'Собрать обзор рынка со ссылками, который не стыдно показать.',
   stack:['research:Perplexity','text:Claude','office:Gamma'],
   how:'Perplexity собирает факты со ссылками, Claude сводит их в структуру и убирает воду, Gamma верстает. Три шага вместо одного — потому что каждый делает своё.',
   catch:'Просить сразу презентацию — получишь красивую пустоту. Сначала факты, потом структура, только потом вёрстка.',
   time:'40 минут вместо половины дня'},

  {id:'sh-machine2', fam:'machine', art:'show-machine2',
   title:'Разбор встречи в задачи',
   task:'Превратить часовой созвон в список дел с владельцами и сроками.',
   stack:['meet:Fireflies','text:Claude'],
   how:'Fireflies даёт расшифровку, Claude разбирает её на итоги, задачи и спорные места. Отдельным пунктом прошу «где не договорились» — экономит следующую встречу.',
   catch:'Без явного требования «кто — что — до какого числа» получаешь список пожеланий, а не задач.',
   time:'6 минут после звонка'},

  {id:'sh-trade2', fam:'trade', art:'show-trade2',
   title:'Воронка из пяти слайдов',
   task:'Не одна карточка, а последовательность: захват, выгоды, состав, отзыв, призыв.',
   stack:['mp:Fabula AI','mp:Supa'],
   how:'Fabula собирает воронку целиком по одному товару, Supa доводит слайды, где нужен ручной контроль. Единый стиль важнее красоты отдельного кадра.',
   catch:'Пятый слайд почти всегда лишний, если первые четыре сделаны честно. Проверял на своих карточках.',
   time:'25 минут на товар'},
...
const FAILS = [
  ...
  {id:'f-nbsp', tag:'[МОЯ ОШИБКА]', date:'28 июля 2026', fam:'word',
   title:'Скрипт, который испортил тексты за одну секунду',
   what:'Захотел убрать висячие предлоги — написал скрипт, который проходит по странице и приклеивает короткие слова неразрывным пробелом.',
   went:'Он вписал <b>&amp;nbsp; прямо в текстовые узлы</b>. Внешне всё выглядело нормально, но при копировании описания ломались, а тексты первого выпуска переставали совпадать с эталоном. Поймала автопроверка целостности — та самая, что сверяет оригинальные массивы побайтово.',
   lesson:'Не трогай контент ради оформления. Если задачу можно решить <b>стилями, а не правкой текста</b> — решай стилями. И держи проверку, которая ловит такие вещи без тебя.',
   now:'Висячие строки убраны через text-wrap: pretty. Текст в разметке остался ровно таким, каким написан.'},

  {id:'f-density', tag:'[МОЯ ОШИБКА]', date:'28 июля 2026', fam:'image',
   title:'Обложки, которые стали дешёвыми',
   what:'Перерисовывал арт и увлёкся чистотой: тонкие линии, много воздуха, аккуратные точки.',
   went:'Получилось пусто. Покрытие краской упало до <b>24%</b> — вместо плотной печати вышел набросок. Читатель сказал прямо: выглядит дёшево и выпадает из концепции. Он был прав.',
   lesson:'Сдержанность — это не разрежённость. Премиальная печать <b>плотная</b>: массивные формы, заливка плоскостями, уверенные пересечения. Пустота работает только рядом с весом.',
   now:'Весь арт перерисован: покрытие 38–79%, формы держат разворот. Плотность теперь замеряю числом, а не на глаз.'},
